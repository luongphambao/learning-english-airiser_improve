...
Hai vòng chỉnh tiếp theo, cùng ngày: (1) chủ dự án chê phần đầu "xấu quá" — bản đầu tròn to kiểu chibi có viền đen riêng quanh mảng xanh trên đỉnh đầu, đọc như một cái mũ bơi/helmet thay vì màu lông tự nhiên; sửa bằng cách bỏ viền riêng đó (mảng xanh giờ chỉ có `fill`, không `stroke`, để đường viền duy nhất là viền ngoài của khối đầu) và đổi mép mảng xanh thành một đỉnh chữ V mềm giữa hai mắt thay vì đường cong đối xứng đơn giản. (2) Chủ dự án gửi một ảnh tham chiếu thứ hai — dáng rắn hổ mang vươn cổ dựng đứng thay vì cuộn tròn với đầu đặt lên trên — và yêu cầu đổi theo đúng dáng đó; `BODY_PATH` viết lại thành một đường cong chữ S đơn liên tục từ đuôi lên cổ, đầu nhỏ thuôn dài gắn ở đỉnh cổ (không còn đầu tròn to kiểu chibi), mắt lồi tròn kiểu "ngạc nhiên" đặt trên đỉnh đầu. Vì đầu giờ bị xoay nghiêng (`rotate(-24deg)`) để khớp dáng vươn cổ, toàn bộ chi tiết mặt (mắt, mày, miệng, lưỡi, giọt nước mắt) được gộp vào chung một `<g>` mang cùng phép xoay `HEAD_TRANSFORM` — bản nháp đầu chỉ xoay riêng hình ellipse đầu mà không xoay mắt/mày theo, khiến đường cong lông mày ở mood `happy`/`excited` lệch hẳn khỏi đầu, tính bằng ma trận xoay ngược thủ công (Python, không phải ước lượng mắt) để chuyển toạ độ tuyệt đối cũ đã kiểm chứng (mắt `idle`/`sad`, vốn là hình tròn nên không bị ảnh hưởng bởi phép xoay) về hệ toạ độ cục bộ trước khi xoay. Lông mày cong cho `happy`/`excited` vẫn tiếp tục lỗi thêm hai lần nữa — đỉnh cong vọt ra ngoài viền ellipse đầu vào khoảng trống phía trên, đọc như một vệt đen rời rạc — trước khi được thay hẳn bằng cách tái dùng đúng cặp mắt tròn của mood `idle` (ổn định, đã kiểm chứng) và chỉ đổi qua nụ cười rộng hơn để biểu đạt vui, thay vì tiếp tục chỉnh tay đường cong lông mày.
