...
| 2 | Routing thật: route group `(tabs)`/`(stack)`, xoá `AppShell` + `screens/` | ✅ Xong | Deep-link `/tien-do` render đúng; nút Back trình duyệt hoạt động |
